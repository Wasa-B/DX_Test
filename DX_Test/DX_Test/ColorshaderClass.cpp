...
bool ColorShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	result = InitializeShader(device, hwnd, (WCHAR*)L"../DX_Test/color.vs", (WCHAR*)L"../DX_Test/color.ps");
	if (!result)
	{
		return false;
	}
...
bool ColorShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	...
	pixelShaderBuffer = 0;
	// 정점 셰이더를 컴파일합니다.
	result = D3DCompileFromFile(vsFilename, NULL, NULL, "ColorVertexShader", "vs_5_0",NULL , NULL,
	...
	// 픽셀 셰이더를 컴파일합니다.
	result = D3DCompileFromFile(psFilename, NULL, NULL, "ColorPixelShader", "ps_5_0", NULL, NULL,
